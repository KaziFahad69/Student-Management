...
class AddCourse2 extends StatefulWidget {
  const AddCourse2({Key? key}) : super(key: key);

  @override
  State<AddCourse2> createState() => _AddCourse2State();
}

class _AddCourse2State extends State<AddCourse2> {
